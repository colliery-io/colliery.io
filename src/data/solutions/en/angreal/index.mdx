...
The name comes from fantasy literature, where an angreal is an object that lets its user safely draw on far more power than they could reach alone; a fair description of a small tool that puts a project's whole workflow behind a single command.
